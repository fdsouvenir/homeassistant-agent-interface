...
5. Run `npm run compat`; confirm the packed artifact registers all six tools on 2026.7.1-2 stable and registers all six output schemas on 2026.8.1 beta 2.
...
8. Install that exact tarball through `npm-pack:` in isolated stable and beta OpenClaw profiles. Confirm the plugin runtime and bundled skills are discovered.
