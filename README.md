...
<p align="center">
  ...
  <img alt="Version 0.4 stable and beta support" src="https://img.shields.io/badge/v0.4-stable%20%2B%20beta-38bdf8.svg" />
</p>
...
```bash
openclaw plugins install git:github.com/fdsouvenir/homeassistant-agent-interface@v0.4.0
```
